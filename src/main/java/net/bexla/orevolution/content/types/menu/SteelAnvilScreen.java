...
@OnlyIn(Dist.CLIENT)
public class SteelAnvilScreen extends ItemCombinerScreen<SteelAnvilMenu> {
    ...
    public SteelAnvilScreen(SteelAnvilMenu menu, Inventory playerInventory, Component title) {
